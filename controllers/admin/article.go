...
func PostBaidu(url string) (string,error) {
	resp, err := http.Post("http://data.zz.baidu.com/urls?site=https://www.tolinzou.top&token=d0Dca7O4TosN7655",
...
func (this *ArticleController) List() {
	...
	if postid != 0 {
		...
		thisurl := fmt.Sprintf("https://http://119.23.237.82:8089%s", post.Link())
